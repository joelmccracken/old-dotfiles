...
* TL;DR
  - ~bin/converge~ to converge the system.
* Introduction
  ...
  stress again and again. I have stopped improving my workstation setup
  because I have felt the fragility -- and non-portability -- of
  having a system full of hacks.

  The other reason really is a question I am trying to answer: Can I
  build a system with which I feel secure? Can I have a computer that
  I think is reasonably safe and secure?

  I personally have nothing to hide, but it bothers me that my
...
* Project Infrastructure
  ...
  [[file:supporting-infrastructure.org][supporting infrastructure]] for the details of all of this.
  Highlights include:
...
** break this huge project into phases/pieces

Restore existing backup functionality
Restore rsync
Restore backup gem functionality

Clean up integration test code things. It's all broken. :(

Figure out home git directory.
- first use separate.
Move to unifying later

- try vault for storing secrets https://vaultproject.io/community.html
...
**** should send to s3
** Nice-to-have
*** use keychain for mac sensitive stuffs
*** TODO add tests for:
